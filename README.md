...
- Ver2.1.0：https://x.com/tanazun0/status/2010596990200275274
...
# 変更履歴
- 2026-09-15　Ver2.1.2 公開
  - 30fps設定のときに、個別エフェクトのフレーム数がズレる不具合を修正。
  - .NET10に対応。
- 2026-01-31　Ver2.1.1 公開
  - 個別エフェクトを1フレーム前の状態で描画することがある（2フレームで変化がないことがある）不具合を修正。
  - YMM v4.48.1.0以降を使う際、プレビュー上の制御点をドラッグすると、マウスと制御点がズレる不具合を修正。  
    （逆に、v4.48.0.5以前ではズレるようになります。）
- 2026-01-12　Ver2.1.0 公開
  ...
  - 変更点をまとめた動画(Xのポスト)：https://x.com/tanazun0/status/2010596990200275274
